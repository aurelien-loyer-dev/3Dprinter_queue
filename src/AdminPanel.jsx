  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 12, color: stateColor, fontWeight: 500 }}>
        ...
        {isPrinting && telemetry?.progress != null && ` — ${telemetry.progress}%`}
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {isPrinting && (
            <button
              ...
              onClick={() => send('pause')}
              style={{
                width: '100%', padding: '7px 0', borderRadius: 8, border: `0.5px solid ${border}`,
                background: dark ? 'rgba(255,200,50,0.12)' : 'oklch(0.97 0.06 80)',
                color: 'oklch(0.5 0.16 70)', fontWeight: 600, fontSize: 12,
          ...
          {isPaused && (
            <button
              ...
              style={{
                width: '100%', padding: '7px 0', borderRadius: 8, border: `0.5px solid ${border}`,
                background: dark ? 'rgba(50,200,100,0.12)' : 'oklch(0.97 0.06 145)',
                color: 'oklch(0.45 0.16 145)', fontWeight: 600, fontSize: 12,
                cursor: busy ? 'not-allowed' : 'pointer', opacity: busy ? 0.5 : 1,
              }}
            >
              ▶ Reprendre
          ...
          <button
            disabled={busy}
            onClick={() => { if (confirm(`Annuler l'impression sur ${printer.name} ?`)) send('stop'); }}
            style={{
              width: '100%', padding: '7px 0', borderRadius: 8, border: `0.5px solid ${border}`,
              background: dark ? 'rgba(220,60,40,0.12)' : 'oklch(0.97 0.04 25)',
              color: 'oklch(0.5 0.18 25)', fontWeight: 600, fontSize: 12,
              cursor: busy ? 'not-allowed' : 'pointer', opacity: busy ? 0.5 : 1,
            }}
          >
